...
> For more information on `gps`, go on [our `gps` detail page](/docs/nodes_operators/gps_op.md)
...
<p align="center">
    <img src="/img/planning.png" width="800"/>
</p>


> For more information on `fot`, go on [our `fot` detail page](/docs/nodes_operators/fot_op.md)
