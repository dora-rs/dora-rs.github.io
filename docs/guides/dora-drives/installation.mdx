...
|CUDA|11.7||
|dora-rs|0.2.6|Installation below|
...
sudo wget https://github.com/dora-rs/dora/releases/download/v0.2.6/dora-v0.2.6-x86_64-Linux.zip && sudo unzip dora-v0.2.6-x86_64-Linux.zip -d /usr/local/bin 
``` 
